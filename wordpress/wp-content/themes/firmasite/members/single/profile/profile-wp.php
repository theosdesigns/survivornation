...
<?php do_action( 'bp_before_profile_field_content' ); ?>
	...
	<div class="bp-widget wp-profile">
		...
		<table class="table table-hover  wp-profile-fields">

			<?php if ( $ud->display_name ) : ?>

				<tr id="wp_displayname">
					<td class="label"><?php _e( 'Name', 'firmasite' ); ?></td>
			...
			<?php if ( $ud->user_description ) : ?>
				...
				<tr id="wp_desc">
					<td class="label"><?php _e( 'About Me', 'firmasite' ); ?></td>
			...
			<?php if ( $ud->user_url ) : ?>
				...
				<tr id="wp_website">
					<td class="label"><?php _e( 'Website', 'firmasite' ); ?></td>
			...
			<?php if ( $ud->jabber ) : ?>
				...
				<tr id="wp_jabber">
					<td class="label"><?php _e( 'Jabber', 'firmasite' ); ?></td>
			...
			<?php if ( $ud->aim ) : ?>
				...
				<tr id="wp_aim">
					<td class="label"><?php _e( 'AOL Messenger', 'firmasite' ); ?></td>
			...
			<?php if ( $ud->yim ) : ?>
				...
				<tr id="wp_yim">
					<td class="label"><?php _e( 'Yahoo Messenger', 'firmasite' ); ?></td>
