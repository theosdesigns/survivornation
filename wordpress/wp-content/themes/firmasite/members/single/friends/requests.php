...
<?php if ( bp_has_members( 'type=alphabetical&include=' . bp_get_friendship_requests() ) ) : ?>
	...
	<div id="pag-top" class="pagination no-ajax">
		...
		<div class="pagination-links lead" id="member-dir-pag-top">
		...
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id(); ?>">
				...
				<div class="item">
					...
					<div class="item-meta"><span class="activity label label-info"><?php bp_member_last_active(); ?></span></div>
				</div>

				<?php do_action( 'bp_friend_requests_item' ); ?>

				<div class="action">
					<a class="button btn  accept" href="<?php bp_friend_accept_request_link(); ?>"><?php _e( 'Accept', 'firmasite' ); ?></a> &nbsp;
					<a class="button btn  reject" href="<?php bp_friend_reject_request_link(); ?>"><?php _e( 'Reject', 'firmasite' ); ?></a>
	...
	<div id="pag-bottom" class="pagination no-ajax">
		...
		<div class="pagination-links lead" id="member-dir-pag-bottom">
