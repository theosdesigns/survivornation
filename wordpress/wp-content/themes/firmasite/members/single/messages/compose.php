<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main">
	...
	<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'firmasite' ); ?></label>
	...
	<label for="subject"><?php _e( 'Subject', 'firmasite' ); ?></label>
	<input type="text" name="subject" id="subject" value="<?php bp_messages_subject_value(); ?>" />

	<label for="content"><?php _e( 'Message', 'firmasite' ); ?></label>
