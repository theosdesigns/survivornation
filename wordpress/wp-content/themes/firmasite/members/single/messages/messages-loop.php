			...
			<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread"<?php else: ?> read"<?php endif; ?>>
				...
				<?php if ( 'sentbox' != bp_current_action() ) : ?>
					<td width="30%" class="thread-from">
						...
						<span class="activity label label-info"><?php bp_message_thread_last_post_date(); ?></span>
					</td>
				<?php else: ?>
					<td width="30%" class="thread-from">
				...
				<td width="50%" class="thread-info">
					<p><a href="<?php bp_message_thread_view_link(); ?>" title="<?php _e( "View Message", 'firmasite' ); ?>"><?php bp_message_thread_subject(); ?></a></p>
				...
				<td width="13%" class="thread-options">
					...
					<a class="button btn  confirm" href="<?php bp_message_thread_delete_link(); ?>" title="<?php _e( "Delete Message", 'firmasite' ); ?>"><?php _e( 'Delete', 'firmasite' ); ?></a> &nbsp;
				</td>
			</tr>
