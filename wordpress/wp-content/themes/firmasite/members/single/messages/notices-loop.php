...
<?php if ( bp_has_message_threads() ) : ?>
	...
	<div class="pagination no-ajax" id="user-pag">
		...
		<div class="pagination-links lead" id="messages-dir-pag">
	...
	<table id="message-threads" class="table messages-notices">
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			<tr id="notice-<?php bp_message_notice_id(); ?>" class="<?php bp_message_css_class(); ?>">
				...
				<td width="21%">
					...
					<span class="activity label label-info"><?php _e( 'Sent:', 'firmasite' ); ?> <?php bp_message_notice_post_date(); ?></span>
				</td>

				<?php do_action( 'bp_notices_list_item' ); ?>

				<td width="10%">
					<a class="button btn " href="<?php bp_message_activate_deactivate_link(); ?>" class="confirm"><?php bp_message_activate_deactivate_text(); ?></a>
					<a class="button btn " href="<?php bp_message_notice_delete_link(); ?>" class="confirm" title="<?php _e( "Delete Message", 'firmasite' ); ?>">x</a>
				</td>
			</tr>
		<?php endwhile; ?>
