...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<div id="whats-new-content" class="clearfix">
		<div id="whats-new-textarea">
			<?php $content = ""; if ( isset( $_GET['r'] ) ) : $content = "@". esc_attr( $_GET['r'] ); endif;
		...
		<div id="whats-new-options">
			<div id="whats-new-submit" class="pull-right">
				<input type="submit" class="btn  btn-primary" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php _e( 'Post Update', 'firmasite' ); ?>" />
			</div>
			...
			<?php if ( bp_is_active( 'groups' ) && !bp_is_my_profile() && !bp_is_group() ) : ?>
				...
				<div id="whats-new-post-in-box">
					...
					<?php _e( 'Post in', 'firmasite' ); ?>:

					<select id="whats-new-post-in" name="whats-new-post-in">
						<option selected="selected" value="0"><?php _e( 'My Profile', 'firmasite' ); ?></option>
