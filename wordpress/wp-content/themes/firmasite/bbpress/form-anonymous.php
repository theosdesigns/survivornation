...
<?php if ( bbp_is_anonymous() || ( bbp_is_topic_edit() && bbp_is_topic_anonymous() ) || ( bbp_is_reply_edit() && bbp_is_reply_anonymous() ) ) : ?>
	...
	<fieldset class="bbp-form">
		...
		<p>
			<label for="bbp_anonymous_author"><?php _e( 'Name (required):', 'firmasite' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_email"><?php _e( 'Mail (will not be published) (required):', 'firmasite' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_website"><?php _e( 'Website:', 'firmasite' ); ?></label><br />
