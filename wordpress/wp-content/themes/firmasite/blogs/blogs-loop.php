...
<?php if ( bp_has_blogs( bp_ajax_querystring( 'blogs' ) ) ) : ?>
	...
	<div id="pag-top" class="pagination muted">
		...
		<div class="pagination-links lead" id="blog-dir-pag-top">
	...
	<?php while ( bp_blogs() ) : bp_the_blog(); ?>
		...
		<li>
			...
			<div class="item">
				...
				<div class="item-meta"><span class="activity label label-info"><?php bp_blog_last_active(); ?></span></div>
	...
	<div id="pag-bottom" class="pagination muted">
		...
		<div class="pagination-links lead" id="blog-dir-pag-bottom">
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'Sorry, there were no sites found.', 'firmasite' ); ?></p>
	</div>
