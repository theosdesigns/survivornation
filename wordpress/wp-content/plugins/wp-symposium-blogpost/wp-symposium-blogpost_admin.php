...
function symposium_blogpost_admin_page() {
	...
	if ( isset($_POST["symposium_update"]) && $_POST["symposium_update"] == 'symposium_blogpost_menu' ) {
		...
		if ( isset($_POST["add_post_excerpt_to_posts"]) && ($_POST["add_post_excerpt_to_posts"] != '') && is_numeric($_POST["add_post_excerpt_to_posts"]) ) update_option('symposium_blogpost_add_post_excerpt_to_posts', intval ($_POST['add_post_excerpt_to_posts']));
		...
		if ( isset($_POST["add_post_excerpt_to_activity"]) && ($_POST["add_post_excerpt_to_activity"] != '') && is_numeric($_POST["add_post_excerpt_to_activity"]) ) {
			$add_post_excerpt_to_activity = intval ($_POST['add_post_excerpt_to_activity'] );
			if ( $add_post_excerpt_to_activity >= 0 ) { update_option('symposium_blogpost_add_post_excerpt_to_activity', $add_post_excerpt_to_activity ); }
		}
		...
		if ( isset($_POST["add_comment_excerpt_to_activity"]) && ($_POST["add_comment_excerpt_to_activity"] != '') && is_numeric($_POST["add_comment_excerpt_to_activity"]) ) {
			$add_comment_excerpt_to_activity = intval ($_POST['add_comment_excerpt_to_activity'] );
			if ( $add_comment_excerpt_to_activity >= 0 ) { update_option('symposium_blogpost_add_comment_excerpt_to_activity', $add_comment_excerpt_to_activity ); }
		}
...
<?php					foreach ($blog_list as $blog) {
				...
				<tr valign="top">
					<td scope="row">&nbsp;</td>
					<td>
						<input type="text" name="add_post_excerpt_to_posts" id="add_post_excerpt_to_posts" value="<?php echo get_option('symposium_blogpost_add_post_excerpt_to_posts', '0'); ?>" />
						<span class="description"><?php echo __('Display the excerpt of posts (or their beginning) at the WPS Profile page > Blog Posts (length of excerpt, 0 for no text)', 'wp-symposium-blogpost'); ?></span>
					</td>
				</tr>
				...
				<tr valign="top">
					<td scope="row">&nbsp;</td>
					<td>
						<input type="text" name="add_post_excerpt_to_activity" id="add_post_excerpt_to_activity" value="<?php echo get_option('symposium_blogpost_add_post_excerpt_to_activity', '0'); ?>" />
						<span class="description"><?php echo __('Display the excerpt of posts (or their beginning) in the WPS Activity (length of excerpt, 0 for no text)', 'wp-symposium-blogpost'); ?></span>
					</td>
				</tr>
...
<?php						foreach ($post_types as $post_type ) {
				...
				<tr valign="top">
					<td scope="row">&nbsp;</td>
					<td>
						<input type="text" name="add_comment_excerpt_to_activity" id="add_comment_excerpt_to_activity" value="<?php echo get_option('symposium_blogpost_add_comment_excerpt_to_activity', '0'); ?>" />
						<span class="description"><?php echo __('Display the beginning of comments in the WPS Activity (length of excerpt, 0 for no text)', 'wp-symposium-blogpost'); ?></span>
					</td>
				</tr>
