...
$attributes['onclick'] = "if ( confirm( '" . esc_html( addcslashes( str_replace( '%username%', $this->user_login, $this->option['settings']['shortcode_js_confirm'] ), "'" ) ) . "' ) ) { window.location.href=this.href } return false;";
